...
| 2026-04-21 | Language division of labor = **Julian handles English, Juan/Freddy handle Spanish** | Julian is the only English speaker in the company (hence the sales role + 20% commission). This is an unfair advantage, not a gap: Spanish-language landing page + Google Voice Spanish line is on the roadmap (deferred to post-Phase-2). Hispanic rural/ag market in Central TX is underserved — competitors aren't indexed for Spanish metal-buildings keywords. |