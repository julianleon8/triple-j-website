...
export function PushOptIn() {
  ...
  return (
    <div className="rounded-xl border border-brand-500/40 bg-(--brand-fg)/5 p-4 flex items-start gap-3">
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-(--brand-fg) text-(--text-on-brand)">
        <BellIcon />
      </div>
      <div className="min-w-0 flex-1">
      ...
      <button
        ...
        className="shrink-0 min-h-10 px-4 rounded-lg text-[13px] font-semibold bg-(--brand-fg) text-(--text-on-brand) hover:bg-(--brand-fg-hover) disabled:opacity-60 transition-colors"
      >
