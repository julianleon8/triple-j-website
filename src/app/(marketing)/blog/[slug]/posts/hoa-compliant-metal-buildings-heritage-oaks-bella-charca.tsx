  ...
  return (
    <>
      <p>
        ...
        Architectural Review Committee (ARC) before construction begins.
      </p>
      <p>
      ...
      <h2>Panel Options by HOA Compliance Level</h2>

      <ComparisonTable
        caption="Metal building panel options ranked by HOA compliance for Central Texas luxury neighborhoods"
        headers={['Panel System', 'Fastener Visibility', 'Aesthetic Profile', 'HOA Compliance', 'Cost Tier']}
        highlightCol={3}
        rows={[
      ...
      <p>
        ...
        roofing&#8221; are describing a standing seam product. If your HOA guidelines include language like
        this, standing seam is likely your required path.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Sandstone and Sierra Tan &#8212; for homes with tan or earth-tone exteriors</li>
        <li>Dark Bronze and Medium Bronze &#8212; for craftsman-style homes with dark trim accents</li>
      ...
      <h2>Single-Contract Turnkey: Why It Matters for HOA Projects</h2>
      <p>
        HOA projects are the cases where the single-contract approach matters most. Coordinating a
        concrete subcontractor, a metal building erector, and a separate permit expediter for a
        HOA-governed project means three different entities who can each introduce delays &#8212; and no
