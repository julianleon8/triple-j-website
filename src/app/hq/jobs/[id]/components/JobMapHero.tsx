      ...
      <div className="rounded-2xl border border-(--border-subtle) bg-(--surface-2) p-5">
        ...
        {mapsDeepLink && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-3 inline-flex items-center gap-2 rounded-xl bg-brand-600 px-3 py-2 text-[14px] font-semibold text-white"
          >
            <Navigation size={14} strokeWidth={2.2} /> Directions
          </a>
        )}
      </div>
    )
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 bg-(--surface-2) px-4 py-2.5">
        ...
        <span className="inline-flex shrink-0 items-center gap-1 text-[13px] font-semibold text-(--brand-fg)">
          <Navigation size={13} strokeWidth={2.2} /> Directions
        </span>
      </div>
    </a>
  )
